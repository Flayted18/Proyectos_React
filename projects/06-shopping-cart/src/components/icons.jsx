export function AddToCartIcon () {
  return (
    <svg xmlns=' https://www.w3.org/TR/SVG/' width='24' height='24' viewBox='0 0 24 24' strokeWidth='1' stroke='currentColor' fill='none' strokeLinecap='round' strokeLinejoin='round'>
